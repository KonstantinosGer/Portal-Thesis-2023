...
type FinancialReportsDataSourceType = {
    id: string,
    name: string
    type: string
...
interface FinancialReportsFilterDateType {
    startDate: string
    endDate: string
}


const FinancialReports = (props: Props) => {
    ...
    const refFinancialReportsTable = useRef<ActionType>();
    ...
    //
    //Date
    const [tmpFilterDate, setTmpFilterDate] = useState<FinancialReportsFilterDateType>({
    ...
    const [filterDate, setFilterDate] = useState<FinancialReportsFilterDateType>({
        startDate: currDate.getFullYear() - 1 + '-' + (currDate.getMonth() + 1 < 10 ? '0' : '') + (currDate.getMonth() + 1) + '-01',
        endDate: currDate.getFullYear() + '-' + (currDate.getMonth() + 1 < 10 ? '0' : '') + (currDate.getMonth() + 1) + '-01',
    });
    ...
    //Initialize columns
    //
    const columns: ProColumns<FinancialReportsDataSourceType>[] = [
        {
    ...
    return (
        <PageContainer>
            ...
            <Row justify={"space-between"}>
                ...
                <Col span={24}>
                    <ProForm<FinancialReportsFilterDateType> layout={"inline"}
            ...
            <Row>
                <Col span={24}>
                    ...
                    <ConfigProvider locale={enUSIntl}>
                        <ProTable<FinancialReportsDataSourceType>
                            params={{
                            ...
                            request={async (params, sort, filter) => {
                                try {
                                    ...
                                    const res = await axiosApiInstance.get('/api/files/getfinancialapproved', {
                                        params: {
                                            // For Filtering
                                            // ...filter,
                            ...
                            actionRef={refFinancialReportsTable}
                            columns={columns}
                            rowKey="id"
                            // onLoad={(dataSource) => {
                            ...
                            columnsState={{
                                persistenceKey: 'financial-reports-files',
